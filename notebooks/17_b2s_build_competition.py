"""Execute the Bronze-to-Silver competition-stage tables."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Execute the Bronze-to-Silver competition-stage tables."
    )
...
def main() -> None:
    ...
    print("Competition tables completed:")
    ...
    set_task_value(dbutils, "competition_table_count", len(table_runs))
