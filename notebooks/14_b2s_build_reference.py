"""Preview the Bronze-to-Silver reference-stage build configuration."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Preview the Bronze-to-Silver reference-stage build configuration."
    )
...
def main() -> None:
    ...
    table_names = get_stage_table_names(config, "reference")
    ...
    set_task_value(dbutils, "reference_table_count", len(table_names))
