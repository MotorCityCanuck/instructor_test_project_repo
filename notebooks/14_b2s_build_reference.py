"""Execute the Bronze-to-Silver reference-stage tables."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Execute the Bronze-to-Silver reference-stage tables."
    )
...
def main() -> None:
    ...
    print("Reference tables completed:")
    ...
    set_task_value(dbutils, "reference_table_count", len(table_runs))
