...
def test_phase6_target_table_inventory_is_expected() -> None:
    assert PHASE6_TARGET_TABLES == (
        "player_performance_features",
        "player_development_features",
    )


def test_phase7_target_table_inventory_is_expected() -> None:
    assert PHASE7_TARGET_TABLES == (
        "team_performance_features",
        "partnership_effectiveness",
    )


def test_phase8_target_table_inventory_is_expected() -> None:
    assert PHASE8_TARGET_TABLES == (
        "entity_data_quality_confidence",
    )


def test_phase9_target_table_inventory_is_expected() -> None:
    assert PHASE9_TARGET_TABLES == (
...
def test_phase10_target_table_inventory_is_expected() -> None:
...
def test_phase12_target_table_inventory_is_expected() -> None:
    assert PHASE12_TARGET_TABLES == (
